_: {
  flake.nixosModules.services-runner =
    { config, lib, pkgs, ... }:
    let
    ...
    in
    {
      options.services.githubRunner = {
        ...
        version = lib.mkOption {
          type = lib.types.str;
          description = "Version of the GitHub Actions runner.";
          example = "2.315.0";
        };

        sha256 = lib.mkOption {
          type = lib.types.str;
          description = "SHA256 hash of the actions-runner tarball.";
        };

        url = lib.mkOption {
          type = lib.types.str;
          description = "URL of the repository or organization for the runner.";
        };

        tokenPath = lib.mkOption {
          type = lib.types.path;
          description = "Path to a file containing the GitHub Actions runner registration token.";
        };
        ...
        ephemeral = lib.mkOption {
          type = lib.types.bool;
          default = false;
          description = "Configure the runner as ephemeral.";
        };

        replace = lib.mkOption {
          type = lib.types.bool;
          default = true;
          description = "Pass --replace to config.sh.";
        };

        forceReconfigure = lib.mkOption {
          type = lib.types.bool;
          default = false;
          description = "Force local re-configuration.";
        };
